// Test winter break functionality - Browser compatible version
export function testWinterBreakLogic() {
  console.log('🧪 Testing Winter Break Logic...\n');
  
  // Mock the isInWinterBreak function for testing
  function isInWinterBreak(month, winterBreakStartMonth, winterBreakEndMonth) {
...
export function testProjectLevelWinterBreak() {
...
if (typeof window !== 'undefined') {
  console.log('🔍 Winter Break Test Functions Available:');
  console.log('- testWinterBreakLogic(): Tests the winter break date logic');
  console.log('- testProjectLevelWinterBreak(): Tests project type restrictions');
  console.log('\n💡 Run these functions in the browser console to test the functionality!');
}